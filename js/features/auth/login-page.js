...
class LoginPage {
  ...
  async init() {
    ...
    try {
      ...
      await initFirebase();
      console.log('[LoginPage] Firebase initialized');
  ...
  async checkAuthState() {
    try {
      ...
      console.error('[LoginPage] Error checking auth state:', error);
  ...
  async handleGoogleLogin() {
    try {
      ...
      console.log('[LoginPage] ✅ Google login successful:', result.user.uid);
   ...
   */
  redirectAfterLogin() {
    console.log('[LoginPage] Redirecting to:', this.redirectUrl);
